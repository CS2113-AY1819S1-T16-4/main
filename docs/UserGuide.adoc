...
Format: `edit [INDEX] [n/NAME] [p/PHONE_NUMBER] [a/ADDRESS] [dob/DATE_OF_BIRTH] [e/EMAIL] [d/DEPARTMENT] [r/POSITION] [s/SALARY] [b/BONUS]`

Existing values will be updated to the input values.

Examples:

* `edit 4 dob/14 Mar 2000 p/98765432 d/HR r/Manager s/3500`
...
* `delete 4` +
Deletes the employee at index '4'
...
* `modifypay 2 b/4000` +
Modify the bonus of employee with index 2 to 4000
* `modifypay 3 s/2000 b/5000` +
Modify the salary and bonus of employee with index 3 to 2000 and 5000 respectively
